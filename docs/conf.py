# -*- coding: utf-8 -*-
#
# F5 OpenStack BIG-IP Controller documentation build configuration file, created by
...
project = u'F5 OpenStack BIG-IP Controller'
...
html_title = u'F5 OpenStack BIG-IP Controller'
...
latex_documents = [
    (master_doc, 'F5-OpenStack-BIG-IP-Controller.tex', u'F5 OpenStack BIG-IP Controller Documentation',
...
man_pages = [
    (master_doc,
     'f5-openstack-bigip-ctlr',
     u'F5 OpenStack BIG-IP Controller Documentation',
     [author],
     1)
]
...
texinfo_documents = [
    (master_doc, 'f5-openstack-bigip-ctlr',
     u'F5 OpenStack BIG-IP Controller Documentation',
     [author],
     'f5-openstack-bigip-ctlr',
     'manual'),
